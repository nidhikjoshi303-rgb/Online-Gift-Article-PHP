      ...
      <div class="site-breadcrumb">
          ...
          <div class="container">
              <div class="site-breadcrumb-wrap">
                  <h4 class="breadcrumb-title">Shop Grid Two</h4>
                  <ul class="breadcrumb-menu">
                      <li><a href="index.php"><i class="far fa-home"></i> Home</a></li>
                      <li class="active">Shop Grid Two</li>
                  </ul>
              </div>
          </div>
      </div>
                     ...
                     <div class="col-md-12">
                         <div class="shop-sort">
                             ...
                             <div class="shop-sort-gl">
                                 <a href="shop-grid.php" class="shop-sort-grid active"><i class="far fa-grid-round-2"></i></a>
                                 <a href="shop-list.php" class="shop-sort-list"><i class="far fa-list-ul"></i></a>
                             </div>
                         </div>
                     </div>
