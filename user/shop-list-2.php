    ...
    <div class="site-breadcrumb">
        ...
        <div class="container">
            <div class="site-breadcrumb-wrap">
                <h4 class="breadcrumb-title">Shop List Two</h4>
                <ul class="breadcrumb-menu">
                    <li><a href="index.php"><i class="far fa-home"></i> Home</a></li>
                    <li class="active">Shop List Two</li>
                </ul>
            </div>
        </div>
    </div>
                    ...
                    <div class="col-md-12">
                        <div class="shop-sort">
                            ...
                            <div class="shop-sort-gl">
                                <a href="shop-grid.php" class="shop-sort-grid"><i class="far fa-grid-round-2"></i></a>
                                <a href="shop-list.php" class="shop-sort-list active"><i class="far fa-list-ul"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="shop-item-wrap item-2 item-list">
                        <div class="row g-4">
                            <div class="col-md-12">
                                <div class="product-item">
                                    ...
                                    <div class="product-content">
                                        ...
                                        <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry 
                                            ...
                                            a type specimen book remaining essentially unchanged.</p>
                            ...
                            <div class="col-md-12">
                                <div class="product-item">
                                    <div class="product-img">
                                        <a href="shop-single.php"><img src="assets/img/product/08.png" alt=""></a>
                                        <div class="product-action-wrap">
                                            <div class="product-action">
                                                <a href="#" data-bs-toggle="modal" data-bs-target="#quickview" data-tooltip="tooltip" title="Quick View"><i class="far fa-eye"></i></a>
                                                <a href="#" data-tooltip="tooltip" title="Add To Wishlist"><i class="far fa-heart"></i></a>
                            ...
                            <div class="col-md-12">
                                <div class="product-item">
                                    <div class="product-img">
                                        <a href="shop-single.php"><img src="assets/img/product/09.png" alt=""></a>
                                        <div class="product-action-wrap">
                                            <div class="product-action">
                                                <a href="#" data-bs-toggle="modal" data-bs-target="#quickview" data-tooltip="tooltip" title="Quick View"><i class="far fa-eye"></i></a>
                                                <a href="#" data-tooltip="tooltip" title="Add To Wishlist"><i class="far fa-heart"></i></a>
                            ...
                            <div class="col-md-12">
                                <div class="product-item">
                                    <div class="product-img">
                                        <a href="shop-single.php"><img src="assets/img/product/10.png" alt=""></a>
                                        <div class="product-action-wrap">
                                            <div class="product-action">
                                                <a href="#" data-bs-toggle="modal" data-bs-target="#quickview" data-tooltip="tooltip" title="Quick View"><i class="far fa-eye"></i></a>
                                                <a href="#" data-tooltip="tooltip" title="Add To Wishlist"><i class="far fa-heart"></i></a>
                            ...
                            <div class="col-md-12">
                                <div class="product-item">
                                    <div class="product-img">
                                        <a href="shop-single.php"><img src="assets/img/product/11.png" alt=""></a>
                                        <div class="product-action-wrap">
                                            <div class="product-action">
                                                <a href="#" data-bs-toggle="modal" data-bs-target="#quickview" data-tooltip="tooltip" title="Quick View"><i class="far fa-eye"></i></a>
                                                <a href="#" data-tooltip="tooltip" title="Add To Wishlist"><i class="far fa-heart"></i></a>
                            ...
                            <div class="col-md-12">
                                <div class="product-item">
                                    <div class="product-img">
                                        <span class="type hot">Hot</span>
                                        <a href="shop-single.php"><img src="assets/img/product/12.png" alt=""></a>
                                        <div class="product-action-wrap">
                                            <div class="product-action">
                                                <a href="#" data-bs-toggle="modal" data-bs-target="#quickview" data-tooltip="tooltip" title="Quick View"><i class="far fa-eye"></i></a>
                                                <a href="#" data-tooltip="tooltip" title="Add To Wishlist"><i class="far fa-heart"></i></a>
                            ...
                            <div class="col-md-12">
                                <div class="product-item">
                                    <div class="product-img">
                                        <a href="shop-single.php"><img src="assets/img/product/13.png" alt=""></a>
                                        <div class="product-action-wrap">
                                            <div class="product-action">
                                                <a href="#" data-bs-toggle="modal" data-bs-target="#quickview" data-tooltip="tooltip" title="Quick View"><i class="far fa-eye"></i></a>
                                                <a href="#" data-tooltip="tooltip" title="Add To Wishlist"><i class="far fa-heart"></i></a>
                    ...
                    <div class="shop-sidebar">
                        ...
                        <div class="shop-widget">
                            ...
                            <ul class="shop-category-list">
                                <li><a href="#">Home & Living<span>(15)</span></a></li>
                                <li><a href="#">Garment Care<span>(23)</span></a></li>
                                <li><a href="#">Jewelry & Accessories<span>(35)</span></a></li>
                                <li><a href="#">Occasion Gifts<span>(46)</span></a></li>
                                <li><a href="#">Office & Stationery<span>(39)</span></a></li>
                                <li><a href="#">Personalised Gifts<span>(79)</span></a></li>
                                <li><a href="#">Gifts Box<span>(28)</span></a></li>
                            ...
                            <ul class="shop-checkbox-list">
                                <li>
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label" for="brand1">Tovola<span>(12)</span></label>
                                    </div>
                                </li>
                                <li>
                                    <div class="form-check">
                                ...
                                <li>
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label" for="brand3">Sahoo Gifts<span>(20)</span></label>
                                    </div>
                                </li>
                                <li>
                                    <div class="form-check">
                                ...
                                <li>
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label" for="brand5">Mainden Gifts<span>(09)</span></label>
                                    </div>
                                </li>
                            </ul>
                        </div>
