            ...
            <div class="row">
                ...
                <div class="col-md-12 col-lg-6 col-xxl-6">
                    <div class="shop-single-info">
                        <h4 class="shop-single-title">Special Gift Box</h4>
                        ...
                        <div class="shop-single-sortinfo">
                            <ul>
                                ...
                                <li>SKU: <span>266TYFD</span></li>
                                <li>Category: <span>Jewelry & Accessories</span></li>
                                <li>Brand: <a href="#">Novak</a></li>
                                <li>Tags: <a href="#">Gifts</a>,<a href="#">Watch</a>,<a href="#">Modern</a>,<a href="#">Shop</a></li>
                            </ul>
                        </div>
